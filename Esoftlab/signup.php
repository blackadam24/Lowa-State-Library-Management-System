...
<div class="form2" >
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="utype" aria-describedby="emailHelp">
  ...
  <button type="submit" class="btn btn-primary" name="user_s" id="prof">Signup</button>
...
$utype = $_POST['utype'];
$mobile = $_POST['mobile'];
$sql = "INSERT INTO user(NIC,Email,Passcode,Fname,Lname,Usertype,Mobile) values ('$nic','$email','$passcode','$fname','$lname','$utype','$mobile')";
